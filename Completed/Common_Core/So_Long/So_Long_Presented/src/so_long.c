...
/*   Updated: 2025/11/25 13:55:50 by lde-san-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	sl_game_init(t_game *game, char *win_name);
...
static void	sl_game_init(t_game *game, char *win_name)
{
	...
	game -> win = mlx_new_window(game -> mlx, w, h, win_name);
	if (!game -> win)
