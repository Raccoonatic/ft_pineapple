...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   make_echoes_echosed.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: lde-san- <lde-san-@student.42porto.co      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/08 15:18:45 by lde-san-          #+#    #+#             */
/*   Updated: 2025/10/09 10:51:54 by lde-san-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	{	
		...
		else if (hat_shoe > 1 || hat_shoe == 0)
		{
			...
			else
			{
				...
				line_num++;
				write(1, "\t@sed -i \'", str_len("\t@sed -i \'"));
				if (line_num >= 1 && line_num < 10)
					write(1,rputnum(line_num), 1);
				else if (line_num >= 10 && line_num < 100)
					write(1,rputnum(line_num), 2);
				else if(line_num >= 100 && line_num < 1000)
					write(1,rputnum(line_num), 3);
				else if (line_num >= 1000 && line_num < 10000)
					write(1,rputnum(line_num), 4);
				else if (line_num >= 10000 && line_num < 100000)
					write(1,rputnum(line_num), 5);
				write(1, "s/.*/", str_len("s/.*/"));
			}
		}
		guide = 0;
